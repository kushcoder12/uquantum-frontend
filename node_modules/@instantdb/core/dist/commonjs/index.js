...
config, Storage, NetworkListener, versions, EventSourceImpl) {
    ...
    const reactor = new Reactor_js_1.default(Object.assign(Object.assign(Object.assign({}, defaultConfig), configStrict), { cardinalityInference: configStrict.schema ? true : false }), Storage || IndexedDBStorage_ts_1.default, NetworkListener || WindowNetworkListener_js_1.default, Object.assign(Object.assign({}, (versions || {})), { '@instantdb/core': version_ts_1.default }), EventSourceImpl);
