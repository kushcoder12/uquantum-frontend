...
exports.retractTriple = retractTriple;
...
exports.getBlobAttrs = getBlobAttrs;
...
function mergeTriple(store, attrsStore, rawTriple) {
    ...
    const updatedValue = (0, object_js_1.immutableDeepMerge)(currentValue, update);
